...
- Не з'ясовано, що саме падає: апсервер, MySQL чи вся VM. Важливо, бо TAF сам тримає до 3 MySQL-з'єднань на воркер (до ~108 при 36 проектах) плюс 1 811 прямих SQL-запитів зі спеків; за певного профілю падіння фреймворк є співучасником проблеми.
