...
Повні цифри і докази: `archive/audit-2026-09-15.md`. Тут лише те, що треба тримати в голові.
...
- Пакування 90%: на 9 воркерах прогін обмежений сумарною роботою. Найдовша лінія minor\_company 2h20m стане стелею після ~11 воркерів.
- Найдорожчі тести: no\_dcf 130 s, punchout 118 s, spo 89 s, po\_receive 88 s, common 75 s, budgets 69 s. main\_company 15 s.
- Smoke: 317 тестів, 86% у main\_company.
