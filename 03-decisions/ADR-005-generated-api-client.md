...
## Міграція
Новий клієнт поруч зі старим; фікстури переїжджають першими (вони найбільш централізовані); `precoro_service.ts` видаляється при нулі call-site. Контрольний лічильник: кількість імпортів `precoro_service`.
