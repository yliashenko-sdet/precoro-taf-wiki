...
| [008](ADR-008-monorepo-taf-in-product.md) | Об'єднати репозиторій TAF із репозиторієм продукту | Draft, відкладено 2026-09-25 |
...
## Міграція
Стратегія одним реченням і номери задач із `05-roadmap/plan-to-tasks.md`. Кроки не дублюються.
