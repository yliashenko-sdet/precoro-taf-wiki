...
| T0-10 | Qase-репортер: підключити або видалити | | Рішення з Head of QA; конфіг або package.json | | 0.5 | todo |
| T0-11 | `EnvConfig` зі списку використаних ключів | 002 | Інтерфейс; звіт мертвих і відсутніх ключів | | 1 | todo |
...
| T0-13 | Контрольні лічильники: скрипт, baseline, CI-гейт "тільки вниз" | 001 | `debt-baseline.json` дорівнює правді; PR із ростом червоний; `metrics/debt.jsonl` на мержі | | 1–2 | todo |
| T0-14 | Метрики прогону з JSON + тижневий звіт | 001 | `metrics/runs.jsonl`; `metrics/weekly/*.md` щопонеділка | | 2 | todo |
...
| T1-09 | API-preparation: no_dcf_company | | | s/test 130 → ≤ 45 | 3 | todo |
...
Залежить від відповідей на питання #1, #5, #13.
